...
const List = `<article class="product">
  ...
  <footer class="product__footer">
    ...
    <button type="button" class="product__buy-button2" data-js="buy-button">Buy</button>
  </footer>
</article>`;

document.body.innerHTML += List;

const listenerButton = document.querySelector('[data-js="buy-button"]');
